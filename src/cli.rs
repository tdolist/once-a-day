...
pub fn cli() -> App<'static, 'static> {
    App::new("once-a-day")
        ...
        .subcommand(SubCommand::with_name("screen")
            .about("Use once-a-day in a tmux session")
            .subcommand(SubCommand::with_name("server")
                .about("Run as a server to send mails")
                .arg(Arg::with_name("mail")
                    .help("Your mail address")
            ...
            .subcommand(SubCommand::with_name("run")
                ...
                .arg(Arg::with_name("time")
                    ...
                    .takes_value(true)
                    .required(true)))
            .subcommand(SubCommand::with_name("status").about("Check status of tmux session"))
            .subcommand(SubCommand::with_name("stop").about("Stop a running oad tmux session")))
